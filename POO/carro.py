# A palavra "classe" é usada para criar uma classe 
...
# "self" é uma representa do próprio objeto.
# É através do self que acessamos atributos é métodos do objetos

 # "marca","modelo","ano","velocidade"
 # São Parametros recebido pela classe
...
# "carro1" é uma variavel que recebe um objeto da classe carro.
